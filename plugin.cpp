...
const char* ts3plugin_name() {
	...
	if (!result) {
		const wchar_t* name = L"Color Mode";
		if (wcharToUtf8(name, &result) == -1) {  /* Convert name into UTF-8 encoded result */
			result = "Color Mode";  /* Conversion failed, fallback here */
		}
	}
	return result;
#else
...
const char* ts3plugin_description() {
	/* If you want to use wchar_t, see ts3plugin_name() on how to use */
	return "This plugin makes it easy to switch between dark and lightmode in betterchat";
}
	...
	case PLUGIN_MENU_TYPE_GLOBAL:
		...
		case MENU_ID_GLOBAL_1:
			...
			if (file == NULL) {
				...
				char overWrite[320] = "{     \"AVATARS_ENABLED\": false,     \"COLOR_PROFILE\": true,     \"DOWNLOAD_DIR\": \"hei\",     \"EMBED_ENABLED\": true,     \"EMOTICONS_ENABLED\": true,     \"FAVICONS_ENABLED\": false,     \"FONT_SIZE\": 12,     \"GENERICS_DISABLED\": false,     \"HOVER_ANIMATES_GIFS\": false,     \"MAX_LINES\": 500,     \"REMOTE_EMOTES\": [     ] } ";
		...
		case MENU_ID_GLOBAL_2:
			...
			if (file == NULL) {
				...
				char overWriteLight[320] = "{     \"AVATARS_ENABLED\": false,     \"COLOR_PROFILE\": false,     \"DOWNLOAD_DIR\": \"hei\",     \"EMBED_ENABLED\": true,     \"EMOTICONS_ENABLED\": true,     \"FAVICONS_ENABLED\": false,     \"FONT_SIZE\": 12,     \"GENERICS_DISABLED\": false,     \"HOVER_ANIMATES_GIFS\": false,     \"MAX_LINES\": 500,     \"REMOTE_EMOTES\": [     ] } ";


				fprintf(file, "%s", overWriteLight);
